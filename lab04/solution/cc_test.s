...
inc_arr_loop:
    ...
    # Hint: What does the "t" in "t0" stand for? temporary register 
    # Also ask yourself this: why don't we need to preserve t1? because we need to change byte offset each time
    #
    addi sp, sp, -4
    sw t0, 0(sp)
    jal helper_fn
