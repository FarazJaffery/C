...
# Think: why might having a1 be useful?  --> to load from the output array based on the offset
f:
    # YOUR CODE GOES HERE!
    addi t0, a0, 3    # Add 3 to input x for indexing purpose
    slli t0, t0, 2    # Multiply offset by 4  
    add t0, t0, a1    # Add base address of output, i.e address of output[i]

    lw a0, 0(t0)      # Load result from table
